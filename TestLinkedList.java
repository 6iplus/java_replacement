...
public class TestLinkedList {
	...
	public static LinkedListInt getMarlst(String path){
		LinkedListInt marlst = new LinkedListInt();
	...
	public static LinkedList getArrlst(String path){
		LinkedList arrlst = new LinkedList();
		try { // 防止文件建立或读取失败，用catch捕捉错误并打印，也可以throw  
	...
	public static void main(String [] args){
		...
		LinkedList arrlst = getArrlst(pth2);
		end = System.nanoTime();
		time = end - start;
		...
		//test add function
		start = System.nanoTime();
		LinkedListInt marlst = getMarlst(pth2);
		end = System.nanoTime();
		time = end - start;
		System.out.println("Set up time "+time);
		//test get function
