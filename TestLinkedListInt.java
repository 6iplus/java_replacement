...
public class TestLinkedListInt {
	 ...
	 */
	public static LinkedList<Integer> BuildArrayFromFile(LinkedList<Integer> arr,LinkedList<Integer> list){
	...
	public static LinkedListInt BuildArrayFromFile(LinkedListInt arr,LinkedList<Integer> list) throws FileNotFoundException{
	...
	public static void main(String [] args) throws FileNotFoundException{
		...
		LinkedList<Integer> arrlst = BuildArrayFromFile(new LinkedList<Integer>(), listInt);
		...
		//test add function
		start = System.currentTimeMillis();
		LinkedListInt marlst = BuildArrayFromFile(new LinkedListInt(),listInt);
		end = System.currentTimeMillis();
		time = end - start;
		System.out.println("Set up time "+time+" milliseconds");
